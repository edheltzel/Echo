...
export const ECHO_CONFIG_KEYS = new Set([
  ...
  "ECHO_VOICE_CATCHPHRASE", "ECHO_VOICE_SAY_NAME", "ECHO_PREFERRED_NAME", "ECHO_VOICE_ENABLED", "ECHO_VOICE_GREET_ON_START",
  ...
  "ECHO_CAPTURE_STATE_PATH", "ECHO_PLAYBACK_STATE_PATH", "ECHO_AUDIO_LIFECYCLE_LOG", "ECHO_AUDIO_LIFECYCLE_LOG_MAX_BYTES",
  ...
  "ECHO_CONVERSE_SILENCE_MS", "ECHO_CONVERSE_SILENCE_MODE", "ECHO_CONVERSE_STOP_FILE",
  "ECHO_CONVERSE_TRANSCRIBE_TIMEOUT_MS",
