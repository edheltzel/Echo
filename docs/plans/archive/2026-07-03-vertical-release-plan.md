...
- **B7 - Runtime mute** ✅ SHIPPED (PR #84 → dev 7bc312b, #83 closed 2026-07-03, live closeout verified): global mute switch, timed or indefinite, endpoint + CLI + hotkey contract, log-only, persisted with expiry. (No standalone plan doc was ever filed for this band.)
